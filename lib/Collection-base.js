...
Collection.prototype.findOne = function () {
    ...
    var cb = findArgs.pop();
    this.find.apply(this, findArgs).limit(1).nextObject(function (err, doc) {
        cb(err, doc);
    });
};
...
Collection.prototype._find = Collection.prototype.__find = function (query, fields, skip, limit, sort, order, hint, arFields, cb) {
    var self = this;
    var res = [];
    var range = [];
