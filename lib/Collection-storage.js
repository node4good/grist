...
Collection.prototype._find = function (rawquery, fields, skip, limit, sort_key, order) {
    ...
    if (sort_key) {
        var sorter = _.flow(
            _.property(sort_key),
            function (v) { return (_.isUndefined(v) || _.isNull(v)) ? Number.NEGATIVE_INFINITY : v; }
        );
        work_set = _.sortBy(work_set, sorter);
    }
