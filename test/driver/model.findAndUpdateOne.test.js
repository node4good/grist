...
var BlogPost = new Schema({
    ...
    }, published: Boolean, mixed: {}, numbers: [Number], owners: [ObjectId], comments: [Comments]
});
...
describe('model: findOneAndUpdate:', function () {
        ...
        post.save(function (err) {
            ...
            M.findById(post._id, function (err, cf) {
                ...
                var update = {
                    ...
                    , $inc: { 'meta.visitors': 2 }, $set: { date: new Date }, published: false // becomes $set
                    , 'mixed': { x: 'ECKS', y: 'why' } // $set
                    , $pullAll: { 'numbers': [4, 6] }, $pull: { 'owners': id0 }, 'comments.1.body': 8 // $set
                }
    ...
    it('allows upserting', function (done) {
        ...
        var update = {
            ...
            , $inc: { 'meta.visitors': 2 }, $set: { date: new Date }, published: false // becomes $set
            , 'mixed': { x: 'ECKS', y: 'why' } // $set
            , $pullAll: { 'numbers': [4, 6] }, $pull: { 'owners': id0 }
        }
