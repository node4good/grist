...
Comments.add({
    title: String, date: Date, body: String, comments: [Comments]
});

var BlogPost = new Schema({
    title: String, author: String, slug: String, date: Date, meta: {
        date: Date, visitors: Number
    }, published: Boolean, mixed: {}, numbers: [Number], owners: [ObjectId], comments: [Comments], nested: { array: [Number] }
});
...
describe('Model', function () {
    ...
    describe('isNew', function () {
        ...
        it('on parent and subdocs on failed inserts', function (done) {
            ...
            var schema = new Schema({
                name: { type: String, unique: true }, em: [new Schema({ x: Number })]
            }, { collection: 'testisnewonfail_' + random() });

            var A = db.model('isNewOnFail', schema);

            A.on('index', function () {
                var a = new A({ name: 'i am new', em: [
                    { x: 1 }
                ] });
                a.save(function (err) {
                    assert.ifError(err);
    ...
    describe('structure', function () {
                ...
                it('to a non-empty array', function (done) {
                    var db = start()
                        , DefaultArraySchema = new Schema({
                            arr: {type: Array, cast: String, default: ['a', 'b', 'c']}, single: {type: Array, cast: String, default: ['a']}
                        });
                ...
                it('empty', function (done) {
                    var db = start()
                        , DefaultZeroCardArraySchema = new Schema({
                            arr: {type: Array, cast: String, default: []}, auto: [Number]
                        });
        ...
        describe('init', function () {
            it('works', function (done) {
                ...
                post.init({
                    title: 'Test', slug: 'test', date: new Date, meta: {
                        date: new Date, visitors: 5
                    }, published: true, owners: [new DocumentObjectId, new DocumentObjectId], comments: [
            ...
            it('partially', function (done) {
                ...
                var post = new BlogPost;
                post.init({
                    title: 'Test', slug: 'test', date: new Date
                });
            ...
            it('isNew on embedded documents after saving', function (done) {
                ...
                post.comments.push({ title: 'Humpty Dumpty', comments: [
                    {title: 'nested'}
                ] });
    ...
    describe('casting', function () {
        ...
        it('date casting compat with datejs (gh-502)', function (done) {
            ...
            Date.prototype.toObject = function () {
                return {
                    millisecond: 86, second: 42, minute: 47, hour: 17, day: 13, week: 50, month: 11, year: 2011
                };
            };

            var S = new Schema({
                name: String, description: String, sabreId: String, data: {
                    lastPrice: Number, comm: String, curr: String, rateName: String
                }, created: { type: Date, default: Date.now }, valid: { type: Boolean, default: true }
            });
    ...
    describe('validation', function () {
        it('works', function (done) {
            ...
            mongoose.model('TestValidation', new Schema({
                simple: { type: String, required: true }, scope: { type: String, validate: [dovalidate, 'scope failed'], required: true }, asyncScope: { type: String, validate: [dovalidateAsync, 'async scope failed'], required: true }
            }));
        ...
        it('save callback should only execute once (gh-319)', function (done) {
            ...
            var D = db.model('CallbackFiresOnceValidation', new Schema({
                username: { type: String, validate: /^[a-z]{6}$/i }, email: { type: String, validate: /^[a-z]{6}$/i }, password: { type: String, validate: /^[a-z]{6}$/i }
            }));
        ...
        it('of required previously existing null values', function (done) {
            mongoose.model('TestPreviousNullValidation', new Schema({
                previous: { type: String, required: true }, a: String
            }));
        ...
        it('of nested subdocuments', function (done) {
            ...
            var Subdocs = new Schema({
                required: { type: String, required: true }, subs: [Subsubdocs]
            });
            ...
            post.get('items').push({ required: '', subs: [
                {required: ''}
            ] });
    ...
    describe('virtuals', function () {
        it('getters', function (done) {
            var db = start()
                , BlogPost = db.model('BlogPost', collection)
                , post = new BlogPost({
                    title: 'Letters from Earth', author: 'Mark Twain'
                });
    ...
    describe('getters', function () {
        it('with same name on embedded docs do not class', function (done) {
            var Post = new Schema({
                title: String, author: { name: String }, subject: { name: String }
            });
            ...
            var post = new PostModel({
                title: 'Test', author: { name: 'A' }, subject: { name: 'B' }
            });
        ...
        describe('nested', function () {
            ...
            it('works with object literals', function (done) {
                ...
                // set object directly
                post.meta = {
                    date: date - 3000, visitors: 4815162342
                };
            ...
            it.skip('props can be set directly when property was named "type"', function (done) {
                ...
                mongoose.model('MySchema2', new Schema({
                    nested: {
                        type: { type: String, default: 'yep' }, array: {
    ...
    describe('setters', function () {
        it('are used on embedded docs (gh-365 gh-390 gh-422)', function (done) {
            ...
            var Location = new Schema({
                lat: { type: Number, default: 0, set: setLat}, long: { type: Number, set: uptick }
            });

            var Deal = new Schema({
                title: String, locations: [Location]
            });
            ...
            var deal = new Deal({title: "My deal", locations: [
                {lat: 1.2, long: 33}
            ]});
            ...
            b.save(function (err) {
                ...
                b.save(function (err) {
                    ...
                    b.save(function (err) {
                        ...
                        B.findByIdAndUpdate({ _id: b._id }, { $set: { comments: [
                            { title: 'a' }
                        ] }}, function (err, doc) {
                            assert.ifError(err);
    ...
    it('updating an embedded array document to an Object value (gh-334)', function (done) {
        ...
        instance.set({ name: 'name-value', arrData: [
            { name: 'arrName1', subObj: { subName: 'subName1' } }
        ] });
        instance.save(function (err) {
            assert.ifError(err);
    ...
    describe('safe mode', function () {
        it('works', function (done) {
            var Human = new Schema({
                name: String, email: { type: String, index: { unique: true, background: false }}
            });
                ...
                me.save(function (err) {
                    ...
                    Human.findById(me._id, function (err, doc) {
                        ...
                        var copycat = new Human({
                            name: 'Lionel Messi', email: 'rauchg@gmail.com'
                        });
    ...
    describe('console.log', function () {
        it('hides private props', function (done) {
            ...
            var post = new BlogPost({
                title: 'Test', _id: id0, date: date, numbers: [5, 6, 7], owners: [id1], meta: { visitors: 45 }, comments: [
    ...
    describe('backward compatibility', function () {
        ...
        it('with positional notation on path not existing in schema (gh-1048)', function (done) {
            ...
            db.on('open', function () {
                var o = {
                    name: 'gh-1048', _id: new mongoose.Types.ObjectId, databases: {
                        0: { keys: 100, expires: 0}, 15: {keys: 1, expires: 0}
                    }
                };
    ...
    it('setting a path to undefined should retain the value as undefined', function (done) {
        ...
        doc.comments = [
            { title: 'thanksgiving', body: 'yuuuumm' }
        ];
