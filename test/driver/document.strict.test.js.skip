...
describe('document: strict mode:', function () {
    it('should work', function (done) {
        ...
        var raw = {
            ts: { type: Date, default: Date.now }, content: String, mixed: {}, deepMixed: { '4a': {}}, arrayMixed: []
        };
    ...
    it('sub doc', function (done) {
        ...
        var lax = new Schema({
            ts: { type: Date, default: Date.now }, content: String
        }, { strict: false });
    ...
    it('virtuals', function (done) {
        ...
        var strictInstance = new StrictModel({
            email: 'hunter@skookum.com', myvirtual: 'test'
        });
    ...
    describe('"throws" mode', function () {
        it('throws on set() of unknown property', function (done) {
            var schema = Schema({ n: String, docs: [
                {x: [
                    {y: String}
                ]}
            ] });
