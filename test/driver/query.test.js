...
var Product = new Schema({
    tags: {} // mixed
    , array: Array, ids: [Schema.ObjectId], strings: [String], numbers: [Number], comments: [Comment]
});
...
describe('Query', function () {
    ...
    describe('within', function () {
        describe('box', function () {
            it('not via where', function (done) {
                ...
                assert.deepEqual(query._conditions, {gps: {$within: {$box: [
                    [5, 25],
                    [10, 30]
                ]}}});
                done();
        ...
        describe('center', function () {
            it('not via where', function (done) {
                ...
                assert.deepEqual(query._conditions, {gps: {$within: {$center: [
                    [5, 25],
                    5
                ]}}});
                done();
        ...
        describe('centerSphere', function () {
            it('not via where', function (done) {
                ...
                assert.deepEqual(query._conditions, {gps: {$within: {$centerSphere: [
                    [5, 25],
                    5
                ]}}});
                done();
        ...
        describe('polygon', function () {
            it('not via where', function (done) {
                var query = new Query();
                query.within.polygon('gps', [
                    [ 10, 20 ],
                    [ 10, 40 ],
                    [ 30, 40 ],
                    [ 30, 20 ]
                ]);
                assert.deepEqual(query._conditions, {gps: {$within: {$polygon: [
                    [ 10, 20 ],
                    [ 10, 40 ],
                    [ 30, 40 ],
                    [ 30, 20 ]
    ...
    describe('populate', function () {
        it('converts to PopulateOptions objects', function (done) {
            var q = new Query();
            var o = {
                path: 'yellow.brick', match: { bricks: { $lt: 1000 }}, select: undefined, model: undefined, options: undefined, _docs: {}
            }
            q.populate(o);
        ...
        it('accepts space delimited strings', function (done) {
            ...
            var o = {
                path: 'yellow.brick', match: undefined, select: undefined, model: undefined, options: undefined, _docs: {}
            }
    ...
    describe('casting', function () {
        ...
        it.skip('find $ne should not cast single value to array for schematype of Array', function (done) {
            ...
            var params = {
                array: { $ne: 5 }, ids: { $ne: id }, comments: { $ne: comment }, strings: { $ne: 'Hi there' }, numbers: { $ne: 10000 }
            };
        ...
        it.skip('find should not cast single value to array for schematype of Array', function (done) {
            ...
            var params = {
                array: 5, ids: id, comments: comment, strings: 'Hi there', numbers: 10000
            };
        ...
        it('inequality operators for an array', function (done) {
            ...
            var params = {
                ids: { $gt: id }, comments: { $gt: comment }, strings: { $gt: 'Hi there' }, numbers: { $gt: 10000 }
            };
    ...
    describe('querying/updating with model instance containing embedded docs should work (#454)', function () {
        it.skip('works', function (done) {
            ...
            var proddoc = { comments: [
                { text: 'hello' }
            ] };
            var prod2doc = { comments: [
                { text: 'goodbye' }
            ] };
