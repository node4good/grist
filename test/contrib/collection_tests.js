 ...
 * @_function options
 */
/* REASON: Collection options are not supported
 ...
 * @_function isCapped
 */
/* REASON: Caped collections are not supported
    ...
    exports.shouldCorrectlyRetriveACollectionsIndexes = function (configuration, test) {
        ...
        db.open(function (err, db) {
            ...
            db.createCollection('simple_key_based_distinct', function (err, collection) {
                ...
                collection.ensureIndex({loc: 1}, {w: 1}, function (err, result) {
                    test.equal(null, err);
 ...
 * @ignore
 */
/* REASON: Admin methods are not supported
 ...
 * @ignore
 */
/* REASON: Admin collection is not supported
